document.getElementById("compressButton").addEventListener("click", () => {
  ...
  compressPDF(quality, 4);
});
document.getElementById("compressMerge").addEventListener("click", () => mergePDFs());
document.getElementById("compressSplit").addEventListener("click", () => splitPDF());
document.getElementById("convertPDFToJPEG").addEventListener("click", () => convertPDFToJPEG());
document.getElementById("convertJPEGToPDF").addEventListener("click", () => convertJPEGToPDF());
...
document.getElementById("mergePdfInput").addEventListener("change", function() {
